/* ============================================================
   KILN · "Commonplace" — scripts/theme-toggle.js
   Manual [ DARK ] / [ LIGHT ] toggle. Wired automatically by kiln.js
   (initThemeToggle runs inside initKiln); a page only needs a
   `<button class="theme-toggle">` in its chrome.
...
function apply(theme) {
  // Light is the default stock, so we clear the attribute rather than
